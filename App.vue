            ...
            <div class="flex justify-center px-6 my-12">
                ...
                <div class="w-full xl:w-3/4 lg:w-11/12 flex">
                    ...
                    <div class="w-full h-auto p-6 border border-blue-50  hidden lg:block lg:w-5/12 bg-cover rounded-l-lg">
                        <h3 class="pt-4 text-2xl text-center">Membuat Produk !</h3>
                        <form v-on:submit.prevent="addNewProduct" class="p-4 bg-white rounded">
                            ...
                            <div class="grid grid-cols-4 gap-4 p-2">
                                ...
                                <div class="md:col-span-3 col-span-4">
                                    <select v-model="inputP.typeID" class="border border-red-400 rounded">
                    ...
                    <div class="w-full lg:w-7/12 bg-white p-5 rounded-lg lg:rounded-l-none bg-gray-100">
                        <h3 class="pt-4 text-2xl text-center">DAFTAR PRODUK</h3>
                        <table class="w-full">
                            <thead>
                            ...
                            <tbody>
                                <tr v-for="(item, index) in products" :key="index" class="text-black-700">
